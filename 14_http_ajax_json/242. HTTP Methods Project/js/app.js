...
const url = "http(s)://5cab83bbc85e05001452e9c4.mockapi.io/items";
...
function getItemsAPI(cb){
    const url = "https://5cab83bbc85e05001452e9c4.mockapi.io/items";
...
function showItems(data){
    ...
    items.forEach(item =>{
        ...
        justify-content-between flex-wrap item my-2">
        <img src="${item.avatar}" id='itemImage' class='itemImage 
        img-thumbnail' alt="">
...
function deleteItemAPI(id){
    const url = `https://5cab83bbc85e05001452e9c4.mockapi.io/items/${id}`;
    const ajax = new XMLHttpRequest();
